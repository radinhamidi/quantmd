...
def patientInfo(request, patient_id):
    if Patient.objects.filter(id = patient_id).exists():
        ...
        return render_to_response('referring/patient-info.htm',
                                  {'patient': patient, 'appointments':appointments},
                                  context_instance=RequestContext(request)) 
    else:
        return render_to_response('referring/error.htm',{'error': 'No such error'}, 
                                  context_instance=RequestContext(request)) 
...
def createPatient(request):
    ...
    patient.save()
    return render_to_response('referring/patient-create-confirm.htm',
                              {'patient':patient}, context_instance=RequestContext(request))
...
def patient_edit_action(request, patient_id):
    ...
    return render_to_response('referring/patient-edit-confirm.htm',
                              {'patient':patient, 'date':date}, context_instance=RequestContext(request))
